...
annots = loadmat('B12_AC_CTLE.mat')
channel_ac_mag = annots['channel_ac_mag']
channel_ac_mag=channel_ac_mag[0,:]
channel_ctle_ac_mag = annots['channel_ctle_ac_mag']
channel_ctle_ac_mag=channel_ctle_ac_mag[0,:]
ctle_ac_mag = annots['ctle_ac_mag']
ctle_ac_mag=ctle_ac_mag[0,:]
...
ax.plot(ac_freq, ctle_ac_mag, color = 'red', linewidth = 3)
ax.plot(ac_freq, channel_ctle_ac_mag, color = 'green', linewidth = 3)
...
plt.legend(['Channel','RX CTLE', 'Channel w\i RX CTLE'],prop = { "size": 16 ,'weight':'bold'}, loc ="lower left")
