...
channel_ffe_ctle_ac_mag = annots['channel_ffe_ctle_ac_mag']
channel_ffe_ctle_ac_mag=channel_ffe_ctle_ac_mag[0,:]
...
ax.plot(ac_freq, channel_ffe_ctle_ac_mag, color = 'red', linewidth = 3)
...
plt.legend(['Channel','Channel w\i TX FFE & RX CTLE'],prop = { "size": 16 ,'weight':'bold'}, loc ="lower left")
...
plt.savefig('plot_ac_ffe_ctle.pdf')  
